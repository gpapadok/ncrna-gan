    ...
    def train(self, trainset, labels, epochs):
        ...
        for epoch in range(epochs):
            for j in range(n_iter):
                ...
                # Train with fake
                noise = torch.randn(current_batch_size, 1, self.latent_size, device=self.device)
                ...
                # gradient penalty
                epsilon = torch.rand(current_batch_size, 1, 1, device=self.device)
            ...
            print(f'EPOCH {self.epochs_trained+1:2}', end=" | ")
